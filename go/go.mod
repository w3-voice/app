...
require (
	github.com/hood-chat/core v0.3.0
...
replace github.com/multiformats/go-multiaddr => github.com/hood-chat/go-multiaddr v0.8.0-android // tmp, required for Android SDK30
